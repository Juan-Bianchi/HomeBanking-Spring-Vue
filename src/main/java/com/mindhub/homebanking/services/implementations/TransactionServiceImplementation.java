...
public class TransactionServiceImplementation implements TransactionService {
    ...
    public TransactionServiceImplementation(TransactionRepository transactionRepository, ClientService clientService, AccountService accountService){
    ...
    public void postTransactions(Double amount, String description, String origAccountNumb, String destAccountNumb, Authentication authentication) {
        ...
        if(thereIsANullField(amount, description, origAccountNumb, destAccountNumb)){
            String errorMessage = verifyNullFields(amount, description, destAccountNumb, origAccountNumb);
            throw new RuntimeException(errorMessage);
        }
        if(someFiledIsNotValid(amount, origAccountNumb, destAccountNumb)){
            verifyNotValidFields(amount, origAccountNumb, destAccountNumb);
        }
    ...
    private boolean thereIsANullField(Double amount, String description, String origAccountNumb, String destAccountNumb){
    ...
    private boolean someFiledIsNotValid(Double amount, String origAccountNumb, String destAccountNumb){
        return origAccountNumb.equals(destAccountNumb) || !accountService.existsAccountByNumber(origAccountNumb)
                || !accountService.existsAccountByNumber(destAccountNumb) || amount < 1;
    }

    private void verifyNotValidFields(Double amount, String origAccountNumb, String destAccountNumb){
